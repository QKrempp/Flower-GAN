...
def save_samples(index, latent_tensors):
    ...
    save_image(0.5 * fake_images + 0.5, os.path.join(SAMPLE_DIR, fake_fname), nrow=4)
...
ds = ImageDataset(LABELS, DATA_DIR, transform=tt.Compose([tt.ToTensor(), tt.Normalize((0.5, 0.5, 0.5), (0.5, 0.5, 0.5))]))
